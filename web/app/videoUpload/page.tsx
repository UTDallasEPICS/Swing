    ...
    <div className="flex justify-center w-full">
      <label className="relative inline-block">
        <input
          ...
          multiple
        />
        <div className="select-file-button inline-flex items-center justify-center px-4 py-2 text-white rounded-md text-sm font-medium cursor-pointer transition duration-200">
          <Upload className="w-4 h-4 mr-2" />
          Select Files
        </div>
      </label>
